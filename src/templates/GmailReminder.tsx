  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">Great work! You've shortlisted ${countText} for ${company}. Now let's get your outreach emails sent.</p>
        <p style="margin:0 0 12px 0;">To send emails, you need to connect Gmail.</p>
        <p style="margin:0 0 12px 0;">It takes 30 seconds and lets you:</p>
        ...
        <p style="margin:0 0 16px 0;">Everything stays in your inbox. We just make it smarter.</p>
        ...
        <p style="margin:0;">Still have questions? Reply here - we're founders too.</p>
