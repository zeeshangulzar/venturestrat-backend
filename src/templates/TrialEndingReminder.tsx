  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; ${paragraphStyle}">
        ...
        <p style="${headingStyle} margin:0 0 14px 0;">Your 3-day trial ends tonight at midnight. After that, you'll lose access to:</p>
        ...
        <p style="${paragraphStyle} margin:0 0 16px 0;">Upgrade now and keep your momentum going.</p>
        ...
        <p style="${paragraphStyle} margin:0;">Questions? Reply here - we're standing by.</p>
