  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">Congratulations! You just upgraded to VentureStrat AI ${plan}. That's a big step, and we're excited to be part of your fundraising journey.</p>
        <p style="margin:0 0 12px 0;">Here's what matters now: keep pushing.</p>
        ...
        <p style="margin:0 0 16px 0;">The founders who raise are the ones who show up every day and keep moving forward. You've got the tools. Now it's time to use them.</p>
        <p style="margin:0 0 16px 0;">We're always here to help.</p>
        <p style="margin:0 0 16px 0;">Stuck on something? Not sure what to say in an email? Just reply to this message - we'll get back to you fast.</p>
        ...
        <p style="margin:0;">Let's do this,<br/><strong>The VentureStrat Team</strong><br/>P.S. Your receipt and billing details are attached.</p>
      </td>
    </tr>
  `;
