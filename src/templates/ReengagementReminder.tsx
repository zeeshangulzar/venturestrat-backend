  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">It's been a week since we've seen you in VentureStrat. We get it - fundraising can feel overwhelming, and it's easy to put tools aside.</p>
        <p style="margin:0 0 14px 0;">But here's the truth: the founders who raise fastest are the ones who stay consistent. Even 10 minutes a day makes a difference.</p>
        <p style="margin:0 0 12px 0;">Here's what you can do right now:</p>
        ...
        <p style="margin:0 0 16px 0;">You already took the hardest step (signing up). Let's finish what you started.</p>
        ...
        <p style="margin:0;">Need help? Just reply - we're here to support you.</p>
