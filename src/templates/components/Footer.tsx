export const renderFooter = () => `
  <tr>
    <td style="background: linear-gradient(180deg, #112A58 0%, #255BBE 100%); color:#B9BDC2; padding:25px; font-family:'Manrope', Arial, sans-serif; font-style:normal; font-weight:500; font-size:12px; line-height:20px; letter-spacing:-0.02em;">
      The Azure Crown<br/>
      Crescent Road, Palm Jumeirah<br/>
      Dubai, UAE<br/><br/>
