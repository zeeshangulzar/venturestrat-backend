  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">Your trial ended yesterday, and we've paused your access to VentureStrat AI.</p>
        <p style="margin:0 0 12px 0;">Here's what you're missing right now:</p>
        ...
        <p style="margin:0 0 16px 0;">Fundraising is hard enough. Don't let a great tool sit on the sidelines.</p>
        <p style="margin:0 0 12px 0;">Upgrade today and pick up exactly where you left off.</p>
        <p style="margin:0 0 12px 0;">Starter Plan: $59/mth<br/>Pro Plan: $99/mth</p>
        ...
        <p style="margin:0;">Still on the fence? Reply and let's talk.</p>
