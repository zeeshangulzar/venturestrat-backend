  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">Welcome to VentureStrat! You just unlocked the fastest way to find investors, craft outreach emails, and manage your fundraising pipeline - all in one place.</p>
        ...
        <p style="margin:0 0 16px 0;">You have <strong>3 days free</strong> to explore everything. No credit card required.</p>
        <p style="margin:0 0 24px 0;"><strong>Ready? Let's build your investor list.</strong></p>
        ...
        <p style="margin:0;">Cheers,<br/><strong>The VentureStrat Team</strong></p>
      </td>
    </tr>
  `;
