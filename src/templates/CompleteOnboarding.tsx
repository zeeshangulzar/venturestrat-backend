  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">Finish onboarding to unlock investor discovery, outreach, and tracking.</p>
        ...
        <p style="margin:0;">Need help? Reply to this email and we'll assist.</p>
      </td>
    </tr>
  `;
