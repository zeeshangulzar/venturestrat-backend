  ...
  const content = `
    <tr>
      <td style="padding:40px 30px; color:#222; font-size:15px; line-height:1.7;">
        ...
        <p style="margin:0 0 14px 0;">You're officially set up in VentureStrat - great work! Now comes the fun part: finding investors who actually match ${companyName}.</p>
        ...
        <p style="margin:0 0 16px 0;">Most founders shortlist their first investors in under 10 minutes. Once you do, we'll generate your outreach emails automatically.</p>
        <p style="margin:0 0 16px 0;">You've got 2 days left in your trial. Let's make them count.</p>
        ...
        <p style="margin:0;">Need help filtering? Reply here anytime.</p>
